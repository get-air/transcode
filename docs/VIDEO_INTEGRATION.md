...
Tauri applications can bind the Rust library in-process and inject the returned loopback origin. No Tauri plugin is required for the media engine itself.
